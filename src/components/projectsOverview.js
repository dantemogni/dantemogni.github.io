        ...
        <section>
            ...
            <div className="row justify-content-center align-items-center">
                <div className="col col-12 col-sm-6 col-md-4">
                    <a href="https://todoapp-dante.herokuapp.com/" rel="noreferrer" target={"_blank"}>
                        <StaticImage src="../images/todoapp.jpg" placeholder="blurred" />
                    </a> 
                </div>
                <div className="col col-12 col-sm-6 col-md-4">
                    <a href="https://pomodoro-dante.netlify.app/" rel="noreferrer" target={"_blank"}>
                        <StaticImage src="../images/pomodoro.jpg" placeholder="blurred"/>
                    </a>
                </div>
                <div className="col col-12 col-sm-6 col-md-4">
                    <a href="https://estudiomogni.com.ar/" rel="noreferrer" target={"_blank"}>
